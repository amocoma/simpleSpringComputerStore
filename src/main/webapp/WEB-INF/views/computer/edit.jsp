		...
		<div class="container">
			...
			<form:form commandName="computer"
		        ...
		        <div class="actions pull-right">
		            <input type="submit" value="Save" class="btn btn-primary"> or 
		            <a href="/computers/view/${computer.id}" class="btn btn-danger">Cancel</a> 
		        </div>
