...
insert into computer (id,name,introduced,discontinued,company_id) values (529,'SAM Coup��',null,null,null);
...
SELECT setval('computer_id_seq', (SELECT MAX(id) FROM computer));
