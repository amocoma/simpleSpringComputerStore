...
import com.salesforce.de.dg.heroku.config.services.CanvasConsumerConfig;
import com.salesforce.de.dg.heroku.repository.CompanyRepo;

@Configuration
@ComponentScan(
		basePackageClasses = { CompanyRepo.class, LocalJpaRepositoryConfig.class, CanvasConsumerConfig.class},
